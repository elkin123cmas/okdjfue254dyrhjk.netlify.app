    ...
    <div className={styles.containFooterGeneral}>
      ...
      <div className={styles.containDescriptionFooter}>
        <p className={styles.textDescriptionFooterIntern}>
          InDev.co se encuentra en la ciudad de <span className={styles.textSubrayed1}>Guadalajara de Buga, Colombia,
          en el Departamento del Valle del Cauca.</span> <br />
        
          Contáctanos: <span className={styles.textSubrayed1}> support@InDev.co</span> para consultas generales.
        </p>
        <p className={styles.textCopy}>
          Copyright ©2024 InDev.co Ltd. Todos los derechos reservados
        </p>
      </div>
    </div>
  );
